...
# Ship each part's real Y-extent (mm) so the app can scale meshes to true size
# (the engine's OBJ loader normalises to unit height). Generated by gen-parts.
cp "$ROOT/apps/preview/parts/dims.json" "$ROOT/apps/preview/web/dims.json"
echo "dims.json → web/"
